        ...
        switch (opCode.getSymbol())
          {
            ...
            case CMP:     return new InstructionCMP(labels, opCode);
            ...
            case PUTSTR:  return new InstructionPUTSTR(labels, opCode);
            ...
            case DEFINT:  return new InstructionDEFINT(labels, opCode, arg);
            default:
                // force an exception
